...
function UploadVideo({ setUploadVideoPopup }) {
    ...
    return (
        <>
            <div className="fixed top-5 left-0 w-full h-full flex justify-center items-center  bg-opacity-70 z-30">
                <div className="relative w-[95vw] sm:w-3/4 h-[80vh] sm:h-[80vh] mx-auto text-white rounded-lg overflow-y-scroll bg-black bg-opacity-30 backdrop-blur-lg">
                    <form
                        onSubmit={handleSubmit(publishVideo)}
                        className="  space-y-5"
                    >
                        <section className="h-12 sticky top-0 z-50 border-b border-dotted w-full  flex justify-between items-center px-3 bg-black-900 bg-opacity-10 backdrop-blur-lg ">
                        ...
                        <section className="px-6 py-2">
                            <div className="w-full  border border-dotted rounded-lg h-44 p-1 flex flex-col gap-3 justify-center items-center text-center">
                                <div>
                                ...
                                <label
                                    ...
                                    className="cursor-pointer bg-purple-500 text-black font-bold text-sm py-2 px-4 rounded-full"
                                >
                                    Select Files
                                </label>
                                <input
                            ...
                            <div className="space-y-5 mt-2 w-full grid lg:grid-cols-2 grid-cols-1 lg:gap-10 justify-start items-start">
                                ...
                                <div className="w-full">
                                    <GetImagePreview
                                        ...
                                        label="Thumbnail *"
                                        className={
                                            "w-full h-56 border border-dotted rounded-lg  object-contain"
                                        }
                                        cameraIcon={true}
                                        cameraSize={40}
                                    />
                                ...
                                <div className="w-full">
                                    ...
                                    <Input2
                                        type="text"
                                        label="Title *"
                                        className="mb-2 border border-dotted rounded-lg"
                                        {...register("title", {
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            rows="5"
                                            className="focus:bg-[#222222] bg-transparent outline-none border border-dotted rounded-lg w-full mt-1 p-1"
