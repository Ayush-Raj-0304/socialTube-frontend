...
function EditVideo({
    ...
    return (
        <>
            <div className="fixed mt-5 top-0 left-0 w-full h-full flex justify-center items-center  bg-opacity-70 z-50">
                <form
                    onSubmit={handleSubmit(updateVideo)}
                    className=" bg-black bg-opacity-50 backdrop-blur-lg space-y-2 border-dotted rounded-lg h-[30rem] overflow-y-scroll outline-none p-2"
                >
                    <div className="sticky left-0 top-0 z-50  flex justify-between items-center border-dotted rounded-lg px-3 py-1">
                        <div>
                    ...
                    <div className="p-2 grid lg:grid-cols-2 grid-cols-1 gap-5 z-40">
                        <div>
                            <GetImagePreview
                                ...
                                cameraSize={30}
                                className={
                                    "border border-dotted rounded-lg object-contain w-full min-w-xl h-72 min-h-32"
                                }
                                image={thumbnail}
                            />
                        ...
                        <div className="flex flex-col justify-between sm:gap-0 gap-2">
                            ...
                            <div className="mb-4">
                                ...
                                <textarea
                                    rows="4"
                                    className="focus:bg-[#222222] text-sm overflow-y-scroll bg-transparent outline-none border border-dotted rounded-lg w-full mt-1 p-1"
